...
export type EventMap = {
  ...
  // 奇象巡展（ARK_HUB）任务模板事件 —— 名称与 ActivityTable.missionData.template 一致，
  // 事件参数与各模板 param 语义对齐（param[0]=参数类型位，param[1]=activityId）：
  ...
  // 奇象巡展勋章模板事件 —— 名称与 medal_table.template 一致：
