...
- `app/game/service/excel/types_excel_gen.ts` — regenerated from CS decompiled source (`reference/com.hypergryph.arknights_2.7.61.cs`) by `scripts/generate-types.ts --excel`
- `app/game/service/excel/types-playerdata.ts` (796 interfaces, 1065 enums) — regenerated by `scripts/generate-types.ts --playerdata`
