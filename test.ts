...
app.get("/config/prod/official/network_config", (req, res) => {
  const content = JSON.stringify(config.NetworkConfig);
  const data = {
    sign: "sign",
...
app.get("/user/info/v1/basic", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    `https://as.hypergryph.com/user/info/v1/basic?token=${req.query.token}`,
    {
      method: "GET",
      headers: headers as any,
    },
  ...
  const data = {
    ...
    data: {
      agreementUrl: {
        ...
        updateOverview:
          "https://user.hypergryph.com/protocol/plain/ak/overview_of_changes",
        childrenPrivacy:
          "https://user.hypergryph.com/protocol/plain/ak/children_privacy",
      },
      authorized: true,
...
app.get("/general/v1/server_time", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    "https://as.hypergryph.com/general/v1/server_time",
    {
      method: "GET",
      headers: headers as any,
    },
...
app.get("/app/v1/config", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    `https://as.hypergryph.com/app/v1/config?appCode=${req.query.appCode}`,
    {
      method: "GET",
      headers: headers as any,
    },
...
app.get("/u8/user/auth/v1/agreement_version", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    `https://as.hypergryph.com/u8/user/auth/v1/agreement_version?code=${req.query.code}`,
    {
      method: "GET",
      headers: headers as any,
    },
...
app.post("/user/online/v1/loginout", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    "https://as.hypergryph.com/user/online/v1/loginout",
    {
      method: "POST",
      data: JSON.stringify(req.body),
      headers: headers as any,
...
app.post("/u8/pay/getAllProductList", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    "https://as.hypergryph.com/u8/pay/getAllProductList",
    {
      method: "POST",
      data: JSON.stringify(req.body),
      headers: headers as any,
...
app.post("/pay/:a", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    `https://as.hypergryph.com/pay/${req.params.a}`,
    {
      method: "POST",
      data: JSON.stringify(req.body),
      headers: headers as any,
...
app.post("/:b/:a", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    `https://ak-gs-gf.hypergryph.com/${req.params.b}/${req.params.a}`,
    {
      method: "POST",
      data: JSON.stringify(req.body),
      headers: headers as any,
...
app.post("/:b/:a/:c", async (req, res) => {
  ...
  delete headers.host;
  const response = await fetch(
    `https://ak-gs-gf.hypergryph.com/${req.params.b}/${req.params.a}/${req.params.c}`,
    {
      method: "POST",
      data: JSON.stringify(req.body),
      headers: headers as any,
  ...
  printj(
    ...
    `${req.params.b}_${req.params.a}_${req.params.c}_req_`,
  );
  res.send(data);
});
